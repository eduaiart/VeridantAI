...
import fs from "fs";
import type { Certificate, OfferLetter, Employee, CollegeMou } from "@shared/schema";

const COMPANY_NAME = "VERIDANT AI SOLUTION PRIVATE LTD";
const COMPANY_ADDRESS =
   "Shivam Vihar Colony, Beur, Phulwari, Patna-800002, Bihar, India";
...
const SIGNATURE_PATH = path.join(
   process.cwd(),
   "attached_assets",
   "image_1767422192168.png",
); // Internship offer letters
const EMPLOYEE_SIGNATURE_PATH = path.join(
   process.cwd(),
   "attached_assets",
   "image_1767954911326.png",
      ...
      try {
         ...
         if (certificate.validFrom && certificate.validTo) {
            ...
            doc.fontSize(12)
               .fillColor("#64748B")
               .text(
                  `Duration: ${new Date(certificate.validFrom).toLocaleDateString()} - ${new Date(certificate.validTo).toLocaleDateString()}`,
                  { align: "center" },
               );
         }
         ...
         doc.fontSize(12)
            .fillColor("#475569")
            .text(
               `Issued on: ${new Date(certificate.issueDate || new Date()).toLocaleDateString("en-IN", { day: "numeric", month: "long", year: "numeric" })}`,
               { align: "center" },
            );
...
export async function generateOfferLetterPDF(
   ...
   return new Promise(async (resolve, reject) => {
      try {
         ...
         const startDate = offerLetter.startDate
            ? new Date(offerLetter.startDate).toLocaleDateString("en-IN", {
                 day: "numeric",
                 month: "long",
                 year: "numeric",
              })
            : "[Start Date]";
         const endDate = offerLetter.endDate
            ? new Date(offerLetter.endDate).toLocaleDateString("en-IN", {
                 day: "numeric",
                 month: "long",
                 year: "numeric",
              })
         ...
         // Date
         doc.fontSize(10).fillColor("#374151").text(`Date: ${currentDate}`, 50);
         doc.moveDown(1);
         ...
         const fullAddress =
            [internAddress, internCity, internState, internPincode]
               .filter(Boolean)
         ...
         doc.fontSize(11).fillColor("#0EA5E9").text("Nature of Internship");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         // Compensation
         doc.fontSize(11).fillColor("#0EA5E9").text("Compensation");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         // Employment Status
         doc.fontSize(11).fillColor("#0EA5E9").text("Employment Status");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         // Duration
         doc.fontSize(11).fillColor("#0EA5E9").text("Duration and Termination");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         doc.fontSize(11).fillColor("#0EA5E9").text("Intellectual Property");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         // Company Policies
         doc.fontSize(11).fillColor("#0EA5E9").text("Company Policies");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
               "By accepting this offer, you agree that throughout your internship, you will:",
               { lineGap: 3 },
            );
         doc.moveDown(0.5);
         ...
         // Documents Required
         doc.fontSize(11).fillColor("#0EA5E9").text("Documents Required");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
               "Please submit the following documents on or before your joining date:",
               { lineGap: 3 },
            );
         doc.moveDown(0.5);
         ...
         // Governing Law
         doc.fontSize(11).fillColor("#0EA5E9").text("Governing Law");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         doc.moveDown(0.5);
         const institution =
            applicationDetails?.institution || "[Institution Name]";
         ...
         doc.text(`Offer No: ${offerLetter.offerNumber}`, 120, qrY + 15, {
            lineBreak: false,
         });
         doc.text("Scan QR code to verify", 120, qrY + 27, {
            lineBreak: false,
         });
         ...
         doc.text(cinText, pageCenter - cinTextWidth / 2, footerY + 12, {
            lineBreak: false,
         });
...
export async function generateEmployeeOfferLetterPDF(
   details: EmployeeOfferDetails,
   baseUrl: string,
): Promise<Buffer> {
   return new Promise(async (resolve, reject) => {
      try {
         ...
         const reportingManagerPhone =
            details.reportingManagerPhone || COMPANY_PHONE;
         ...
         const publicHolidays =
            details.publicHolidays || "As per Government of India calendar";
         ...
         const acceptanceDeadline =
            details.acceptanceDeadline ||
            acceptanceDate.toLocaleDateString("en-IN", {
               day: "numeric",
               month: "long",
               year: "numeric",
            });
         ...
         // Position Details
         doc.fontSize(11).fillColor("#0EA5E9").text("1. Position Details");
         ...
         const responsibilities = getResponsibilitiesForRole(
         ...
         doc.fontSize(10)
            .fillColor("#374151")
            .text("Your compensation package includes the following:", {
               lineGap: 3,
            });
         doc.moveDown(0.5);
         ...
         const compensationDetails = [
            ...
            "• Statutory benefits (PF, ESI, Gratuity) will be provided as per applicable laws ",
         ];
         ...
         const workingDetails = [
            ...
            "• Overtime Policy: Any overtime work must be pre-approved by your reporting manager.",
         ...
         // Leave Policy
         doc.fontSize(11).fillColor("#0EA5E9").text("5. Leave Policy");
         doc.fontSize(10)
            .fillColor("#374151")
         ...
         // Probation Period
         doc.fontSize(11).fillColor("#0EA5E9").text("6. Probation Period");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         // Notice Period
         doc.fontSize(11).fillColor("#0EA5E9").text("7. Notice Period");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         // Intellectual Property
         doc.fontSize(11).fillColor("#0EA5E9").text("9. Intellectual Property");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         // Documents Required
         doc.fontSize(11).fillColor("#0EA5E9").text("13. Documents Required");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
               "Please submit the following documents on or before your joining date:",
         ...
         // Governing Law
         doc.fontSize(11).fillColor("#0EA5E9").text("15. Governing Law");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         // Acceptance Deadline
         doc.fontSize(11).fillColor("#0EA5E9").text("16. Acceptance Deadline");
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
         ...
         doc.fontSize(10)
            .fillColor("#374151")
            .text(
               "On your joining date, you will be required to sign the following additional agreements:",
               { lineGap: 3 },
            );
         doc.moveDown(0.5);
         ...
         doc.fontSize(8).fillColor("#64748B");
         doc.text(`Offer No: ${offerNumber}`, 120, qrY + 15, {
            lineBreak: false,
         });
         doc.text("Scan QR code to verify", 120, qrY + 27, {
            lineBreak: false,
...
function getResponsibilitiesForRole(
   designation: string,
   department: string,
): string[] {
   ...
   if (
      designationLower.includes("consultant") ||
      designationLower.includes("associate")
   ) {
      return [
   ...
   if (
      ...
      designationLower.includes("developer") ||
   ...
   if (
      departmentLower.includes("finance") ||
